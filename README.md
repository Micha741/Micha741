...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    554 běžné součástky: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    senzory CUI CSXX05B series aj.), 59 modulů
    ...
    pneumatické pohony s výstupem pro solenoidový ventil) a NEN6-8GM40-E2-PUR (nezápustný
    typ)), 2 konektory/přepěťové
