...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    593 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    senzory CUI CSXX05B series aj.), 95 modulů
    ...
    typ), NBB8-18GM50-A0-V1-M1 (automotive M18) a NBB15-30GM50-E0-M-Y242746 (M30, NPN, E1
    homologace, -40 až +85 °C); a fotoelektrická jednocestná závora
