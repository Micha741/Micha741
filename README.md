...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    597 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    senzory CUI CSXX05B series aj.), 99 modulů
    ...
    BC10-QF5.5-RN6X2, BC20-Q20-RZ3X2 a BC20-Q20-AN4X2/S400 (DC verze); a indukční přibližovací
    spínač Pepperl+Fuchs
    ...
    spínač Pepperl+Fuchs CBB4-12GH60-E0-V1 (potravinářský, nerez 316L); a fotoelektrická
    jednocestná závora
