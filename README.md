...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    895 běžných součástek: 117 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    OOK, výstupy s otevřeným kolektorem do 100mA, paměť 10 ovladačů)), 5 konektorů/přepěťových
    ochran (Ethernet/PoE
