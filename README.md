...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    351 běžnou součástku: 93 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; a NTC
    ...
    MOSFET, JFET), 64 integrovaných obvodů
    ...
    22DTH-51M, sériová flash paměť MX25L6406E, USB-I2C most FT200XD aj.), 16 modulů
