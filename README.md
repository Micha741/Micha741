...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    852 běžných součástek: 117 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    a 23 cívek (proudový snímací transformátor MPS Industries
    P4100E5 series, toroidní síťový (50/60Hz) proudový transformátor Talema AC1020 (20A, poměr
    1000:1), síťový (izolační) transformátor INDEL KK 60/EI 22-2/4 / 23-2/4 / 24-2/4 (jádro EI60,
    25-45 VA, epoxidová zalévačka), radiální a SMD výkonové tlumivky, THT/SMD ferritové korálky,
    náhradní cívky
