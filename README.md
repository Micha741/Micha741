...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    569 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    senzory CUI CSXX05B series aj.), 71 modulů
    ...
    typ) a NBB8-18GM50-A0-V1-M1 (automotive M18); a fotoelektrická jednocestná závora
    (through-beam pár vysílač+přijímač) SICK GRSE18S-N2421V (GR18 Inox); a MIPI CSI-2 kamerový
    modul Leopard Imaging LI-OS05A20-MIPI-110H (OmniVision OS05A20, 5 Mpx); a polohové snímače
    ...
    podélné upnutí, M8 konektor) a SMEO-8E-K-24-S6 (reed, vysokoteplotní -40 až +120 °C, montáž
    příslušenstvím)), 2 konektory/přepěťové
