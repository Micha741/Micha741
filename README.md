...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    295 běžných součástek: 84 rezistorů (řada E12, 1 Ω – 8,2 MΩ), 39 kondenzátorů
    ...
    (bipolární NPN/PNP, Darlington, výkonové, MOSFET, JFET), 43 integrovaných obvodů
    (časovače, komparátory, op-zesilovače, regulátory, logická hradla, čítače,
    Wi-Fi mikrokontroléry ESP32, ESP32-C3, ESP8285, ESP8684, Wi-Fi adaptér ESP8089 aj.) a
    4 Wi-Fi/BLE moduly (ESP32-C3-MINI-1, ESP32-C3-WROOM-02, Adafruit Feather HUZZAH ESP8266,
    ESP8684-MINI-1). Tlačítkem „Knihovna”
