...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    522 běžné součástky: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    HOA0709-011, a optické PPG senzory OSRAM SFH 7051 (tepová frekvence) a SFH7050
    (tepová frekvence + SpO2) aj.), 29 modulů
