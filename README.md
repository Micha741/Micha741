...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    465 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    snubber řada Cornell Dubilier SCD), 134 diod
    ...
    alfanumerické displeje AND-8010-B a Texas Instruments TIL302/303/304, obousměrné
    ...
    ISL97652 a ISL78010, TFT-LCD napájecí obvody E-CMOS EC9223 a Torex XC9516 aj.), 17 modulů
    ...
    solární bezdrátové senzory EnOcean ETHSA/ETHSU; a 6,86" IPS TFT LCD modul s kapacitním
    dotykovým panelem AZ Displays ATM0680L2A-CT), 1 konektor/přepěťová ochrana (Ethernet/PoE
