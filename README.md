...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    498 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    snubber řada Cornell Dubilier SCD), 149 diod
    ...
    LaserTechnik QL85H6S-A/B/C, QL78I6S-A/B/C a QL85J6S-A/B/C-L),
    ...
    vlhkosti/teploty HOPERF TH10 a duální PIR pohybové senzory Murata IRA-S410ST03 a
    IRA-S230ST01 aj.), 24 modulů
    ...
    piezoelektrické rázové/vibrační senzory Murata PKGS-00LDP1-R a automotive TPMS
    PKGS-45TAV-R). Tlačítkem „Knihovna”
