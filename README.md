...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    626 běžných součástek: 107 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    snubber řada Cornell Dubilier SCD; a radiální tantalový kondenzátor RCD Components
    TRA10-103), 151 diodu
    ...
    světlo (náhrada CdS) Kodenshi PT23GP11), 109 integrovaných obvodů
    ...
    senzory CUI CSXX05B series aj.; a izolovaný DC/DC měnič TRACO POWER TRA 1 Series), 121 modulů
    ...
    zvukový segment Moflash LED-TLM-AUD-02 (bzučák, pulzní tón)), 4 konektory/přepěťové
    ochrany (Ethernet/PoE
    bleskojistka ESP-100-POE; kolíková lišta Foxconn HB12201; a pouzdra průmyslového konektoru
    HARTING Han-Modular ECO 09 14 001 0722 (kabel-kabel, bez PE, IP20) a 09 14 001 0321
    (panelové, s PE, IP65)) a 9 ostatních součástek (RF
