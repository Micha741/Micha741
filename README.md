...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    374 běžné součástky: 93 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; a NTC
    ...
    disková řada Illinois Capacitor GMR/GQR; a NP0 disk Meritek CCNPO101J50V5B1), 77 diod
    ...
    TRISIL STMicroelectronics SMTPA),
