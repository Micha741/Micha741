...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    290 běžných součástek: 84 rezistorů (řada E12, 1 Ω – 8,2 MΩ), 39 kondenzátorů
    ...
    (bipolární NPN/PNP, Darlington, výkonové, MOSFET, JFET), 40 integrovaných obvodů
    (časovače, komparátory, op-zesilovače, regulátory, logická hradla, čítače,
    Wi-Fi/BLE mikrokontroléry ESP32 a ESP32-C3 aj.) a 2 Wi-Fi/BLE moduly (ESP32-C3-MINI-1,
