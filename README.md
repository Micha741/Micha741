...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    512 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    MOSFET, JFET, IR fototranzistory Lite-On LTR-306 a LTR-1650D), 96 integrovaných obvodů
    ...
    analogový křemenný automotive gyroskop Epson Toyocom XV-8000CB, a galvanicky oddělený
    magnetorezistivní proudový senzor ZMC10 aj.), 28 modulů
