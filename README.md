...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    510 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    kombinovaný senzor přiblížení/okolního osvětlení; a optoelektronické snímače přiblížení SICK
    WTB250-2N1131/WTB250-2N1151), 2 konektory/přepěťové
