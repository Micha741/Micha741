...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    329 běžných součástek: 93 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; a NTC
    ...
    66 tranzistorů (bipolární NPN/PNP, Darlington, duální, komplementární páry, výkonové, VF,
    MOSFET, JFET), 52 integrovaných obvodů
    ...
    mikrokontroléry ATmega640/1280/1281/2560/2561, digitální teploměry DS18B20, DS1822,
    TC625, sériová flash paměť MX25L6406E aj.), 11 modulů (Wi-Fi/BLE: ESP32-C3-MINI-1, ESP32-C3-WROOM-02, Adafruit Feather
