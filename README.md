...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    578 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    senzory CUI CSXX05B series aj.), 80 modulů
    ...
    displejem, IO-Link) a SPAN-B-B11R-R18M-PN-L1+2.5S (tlakový senzor s displejem, "Basic",
    1 výstup)), 2 konektory/přepěťové
