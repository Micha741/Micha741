...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    891 běžných součástek: 117 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    RFM01 (315/433/868/915MHz, citlivost -109dBm, SPI, standalone režim)), 5 konektorů/
    přepěťových
    ochran (Ethernet/PoE
