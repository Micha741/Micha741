...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    529 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    Q130RA; a kapacitní přibližovací spínače TURCK BC10-PT30-AZ3X, BC10-Q14-VN4X2 a
    BC10-QF5.5-RN6X2), 2 konektory/přepěťové
