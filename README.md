...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    617 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    senzory CUI CSXX05B series aj.), 119 modulů
    ...
    SRBE-CA3-YR90-MW-22A-1W-C2M20-EX (mechanický přepínací spínač) a RGB segment signálního
    majáku Banner SG-TL70-RGB14), 2 konektory/přepěťové
