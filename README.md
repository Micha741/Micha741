...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    332 běžné součástky: 93 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; a NTC
    ...
    69 tranzistorů (bipolární NPN/PNP, Darlington, duální, komplementární páry, výkonové, VF,
