...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    511 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    WTB250-2N1131/WTB250-2N1151; a wearable zdravotní senzorový náramek Maxim MAXREFDES103#
    s optickým PPG biosenzorem), 2 konektory/přepěťové
