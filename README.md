...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    856 běžných součástek: 117 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    světlo (náhrada CdS) Kodenshi PT23GP11), 142 integrovaných obvodů
    ...
    optočleny LITE-ON LTV-356T (CTR 50-600%, Viso 3750Vrms, mini-flat SMD) a Everlight EL817
    Series (CTR 50-600%, Viso 5000Vrms, DIP-4/SMD); a plně
