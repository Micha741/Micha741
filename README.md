...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    507 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    MOSFET, JFET, IR fototranzistory Lite-On LTR-306 a LTR-1650D), 94 integrovaných obvodů
    ...
    BD3852MUZ-Z, a 6osý MEMS akcelerometr/gyroskop STMicroelectronics LSM330DL aj.), 25 modulů
