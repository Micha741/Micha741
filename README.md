...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    547 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    světlo (náhrada CdS) Kodenshi PT23GP11), 101 integrovaných obvodů
    ...
    HOA0709-011, a optické PPG senzory OSRAM SFH 7051 (tepová frekvence), SFH7050
    (tepová frekvence + SpO2) a SFH7060 (5 emitorů, tepová frekvence + SpO2) aj.),
    29 modulů
    ...
    BC10-QF5.5-RN6X2 a BC20-Q20-RZ3X2; a indukční přibližovací spínač Pepperl+Fuchs
    ...
    NBB4-12GM30-E2-V3, NBB4-12GM35-A2-V1-M1 (automotive), NBB4-12GM50-E2-3G-3D (ATEX),
    NBB4-12GM75-US, NBB5-18GM40-Z0-V1, NBB8-18GM50-E2 a NBB10-30GM50-E0), 2 konektory/
    přepěťové
