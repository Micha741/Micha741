...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    337 běžných součástek: 93 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; a NTC
    ...
    MOSFET, JFET), 55 integrovaných obvodů
    ...
    TC625, senzory vlhkosti a teploty DHT11 a SHT71/SHT75, sériová flash paměť MX25L6406E aj.),
    11 modulů
