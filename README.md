...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    590 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    senzory CUI CSXX05B series aj.), 92 modulů
    ...
    SPAW-P100R-G14F-2N-M12 (vysokotlaký tenkovrstvý senzor 0-100 bar, celokovový, G1/4)),
