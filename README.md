...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    481 běžnou součástku: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    snubber řada Cornell Dubilier SCD), 143 diod
    ...
    jednomístný displej Everlight ELS-512UBWA, obousměrné přepěťové ochrany TRISIL
    STMicroelectronics
