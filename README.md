...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    893 běžných součástek: 117 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    TX-SAW 434 L (433,92MHz, interně regulované napájení 1,8-12V, náhrada TX-SAW-433/s-Z)),
    5 konektorů/přepěťových
    ochran (Ethernet/PoE
