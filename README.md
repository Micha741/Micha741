...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    335 běžných součástek: 93 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; a NTC
    ...
    MOSFET, JFET), 53 integrovaných obvodů
    ...
    TC625, senzor vlhkosti a teploty DHT11, sériová flash paměť MX25L6406E aj.), 11 modulů
