...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    455 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    snubber řada Cornell Dubilier SCD), 125 diod
    (usměrňovací, spínací, Schottky, Zenerovy,
    LED včetně výkonových SMD LED LUXEON Rebel a OSLON SSL 80, ploché LED displeje ROHM
    LD-201, 7segmentové LED displeje AND Optoelectronics AND-5610 a Texas Instruments
    TIL302/303/304, obousměrné přepěťové ochrany TRISIL STMicroelectronics
