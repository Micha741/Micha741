...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    ...
    QL85J6S-A/B/C-L, proudově omezující dioda Diotec CL05M6F (5,6mA, SOD-123FL), a SMD
    jednofázové můstkové usměrňovače Diotec ABS2/ABS4/ABS6/ABS8/ABS10/ABS10-16 (200-1600V,
    1A)),
