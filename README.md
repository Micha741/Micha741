...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    516 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    MOSFET, JFET, IR fototranzistory Lite-On LTR-306 a LTR-1650D), 100 integrovaných obvodů
    ...
    ACS754xCB-150/ACS755xCB-050 (Hallův jev) aj.), 28 modulů
