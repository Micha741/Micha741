...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    508 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    MOSFET, JFET, IR fototranzistory Lite-On LTR-306 a LTR-1650D), 95 integrovaných obvodů
    ...
    BD3852MUZ-Z, 6osý MEMS akcelerometr/gyroskop STMicroelectronics LSM330DL, a jednoosý
    analogový křemenný automotive gyroskop Epson Toyocom XV-8000CB aj.), 25 modulů
    ...
    Seiko Epson TSU-20G/TSU-70G/TSU-100G; a evaluační deska ROHM RPR-0521RS-EVK-001 pro
    kombinovaný senzor přiblížení/okolního osvětlení), 2 konektory/přepěťové
    ...
    SMD IML-0662N000-T1 a IML-0660). Tlačítkem „Knihovna”
