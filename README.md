...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    338 běžných součástek: 93 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; a NTC
    ...
    MOSFET, JFET), 56 integrovaných obvodů
    ...
    mikrokontroléry ATmega640/1280/1281/2560/2561, AT90CAN128 s CAN řadičem, digitální
    teploměry DS18B20, DS1822, TC625, senzory vlhkosti a teploty DHT11 a SHT71/SHT75,
