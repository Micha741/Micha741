...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    419 běžných součástek: 98 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    SCD4C60S),
    72 tranzistorů (bipolární NPN/PNP, Darlington, duální, komplementární páry, výkonové, VF,
    MOSFET, JFET, IR fototranzistor Lite-On LTR-306), 85 integrovaných obvodů
