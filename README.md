...
- **Databáze součástek** — lokální úložiště SQLite (`expo-sqlite`), běží celé na zařízení bez
  ...
  - **Výchozí knihovna běžných součástek** — při prvním spuštění se automaticky nahraje
    460 běžných součástek: 106 rezistorů (řada E12, 1 Ω – 8,2 MΩ; teplotní senzor Pt100; NTC
    ...
    snubber řada Cornell Dubilier SCD), 130 diod
    (usměrňovací, spínací, Schottky, Zenerovy,
    LED včetně výkonových SMD LED LUXEON Rebel, OSLON SSL 80 a OSRAM TOPLED Black LO T64F
    (černé pouzdro pro VMS displeje), ploché LED displeje ROHM
    LD-201 a LD-001, 7segmentové LED displeje AND Optoelectronics AND-5610 a Texas
    Instruments TIL302/303/304, obousměrné přepěťové ochrany TRISIL STMicroelectronics
